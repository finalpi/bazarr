...
- Manual translation can optionally remove hearing-impaired sound and music cues before sending the source to the translator. The option is off by default, keeps dialogue in mixed cues, uses a disposable source copy, and saves the translated subtitle without an HI tag. Automatic translation and the original source remain unchanged.
