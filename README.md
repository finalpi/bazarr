...
- Manual translation can optionally omit hearing-impaired cues. The option is off by default: obvious sound/music lines are removed from a disposable source copy, and the OpenAI-compatible model is instructed to translate only remaining dialogue and omit cues with no speech. The original source and automatic translation remain unchanged; the translated subtitle is saved without an HI tag.
