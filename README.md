...
- Chinese subtitle discovery adds SubHD and optional R3Sub providers. SubHD uses the current temporary-cookie download flow with trusted-host validation, mirror search, jittered rate limiting, and bounded retries. R3Sub uses an authenticated account for Taiwan official subtitle releases.
