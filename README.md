...
- Prompt the model to preserve personal names, character names, nicknames, and speaker labels in their original Latin spelling when the source subtitle language is English. This is a translation preference rather than a rejecting validator, avoiding false positives from contractions and SDH descriptions. Other source languages continue to use established Chinese translations or transliterations.
