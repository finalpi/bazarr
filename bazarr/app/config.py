...
validators = [
    ...
    Validator('translator.openai_ass_original_font_size', must_exist=True, default=32, is_type_of=int, gte=12, lte=120),
    ...
    Validator('translator.openai_ass_bilingual_margin_v', must_exist=True, default=60, is_type_of=int, gte=0, lte=300),
