...
validators = [
    ...
    Validator('translator.openai_active_profile', must_exist=True, default='default', is_type_of=str,
              is_in=['default', 'profile_1', 'profile_2', 'profile_3']),
    Validator('translator.openai_profile_1_name', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_1_base_url', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_1_api_key', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_1_model', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_2_name', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_2_base_url', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_2_api_key', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_2_model', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_3_name', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_3_base_url', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_3_api_key', must_exist=True, default='', is_type_of=str, cast=str),
    Validator('translator.openai_profile_3_model', must_exist=True, default='', is_type_of=str, cast=str),
    ...
    Validator('translator.openai_styled_ass', must_exist=True, default=False, is_type_of=bool),
    Validator('translator.openai_ass_font_name', must_exist=True, default='Noto Sans CJK SC', is_type_of=str, cast=str),
    Validator('translator.openai_ass_font_size', must_exist=True, default=52, is_type_of=int, gte=12, lte=120),
    Validator('translator.openai_ass_primary_color', must_exist=True, default='#FFFFFF', is_type_of=str, cast=str),
    Validator('translator.openai_ass_outline_color', must_exist=True, default='#000000', is_type_of=str, cast=str),
    Validator('translator.openai_ass_bold', must_exist=True, default=True, is_type_of=bool),
    Validator('translator.openai_ass_outline', must_exist=True, default=3, is_type_of=int, gte=0, lte=10),
    Validator('translator.openai_ass_shadow', must_exist=True, default=1, is_type_of=int, gte=0, lte=10),
    ...
    Validator('translator.openai_ass_chinese_font_size', must_exist=True, default=64, is_type_of=int, gte=12, lte=120),
    ...
    Validator('translator.openai_ass_chinese_shadow', must_exist=True, default=0, is_type_of=int, gte=0, lte=10),
    Validator('translator.openai_ass_original_font_name', must_exist=True, default='Arial', is_type_of=str, cast=str),
    Validator('translator.openai_ass_original_font_size', must_exist=True, default=48, is_type_of=int, gte=12, lte=120),
    Validator('translator.openai_ass_original_primary_color', must_exist=True, default='#FFFFFF', is_type_of=str, cast=str),
    Validator('translator.openai_ass_original_outline_color', must_exist=True, default='#000000', is_type_of=str, cast=str),
    Validator('translator.openai_ass_original_bold', must_exist=True, default=False, is_type_of=bool),
    Validator('translator.openai_ass_original_outline', must_exist=True, default=2, is_type_of=int, gte=0, lte=10),
    Validator('translator.openai_ass_original_shadow', must_exist=True, default=0, is_type_of=int, gte=0, lte=10),
    Validator('translator.openai_ass_bilingual_margin_v', must_exist=True, default=20, is_type_of=int, gte=0, lte=300),
